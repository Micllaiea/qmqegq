...
var stage, world, mc, fps = 24,
    ...
    lastLevel = -1,
    isIngameMusic, fireTimer = null,
    isSomeBombActive, isSoundOn = !0,
...
function startLoad() {
    ...
    data.push({
        name: "gun_left",
        src: a + "Objects/Gameplay_Objects/gun_left.png"
    });
    data.push({
        name: "gun_right",
        src: a + "Objects/Gameplay_Objects/gun_right.png"
    });
    data.push({
    ...
    data.push({
        name: "orangeJump_m_1",
        src: a + "Animations/orangeJump_m/orangeJump_m_1.png"
    });
    data.push({
        name: "orangeJump_m_2",
        src: a + "Animations/orangeJump_m/orangeJump_m_2.png"
    });
    data.push({
        name: "orangeRotation_m_1",
        src: a + "Animations/orangeRotation_m/orangeRotation_m_1.png"
    });
    data.push({
        name: "orangeRotation_m_2",
        src: a + "Animations/orangeRotation_m/orangeRotation_m_2.png"
    });
    data.push({
    ...
    data.push({
        name: "Menu_LevelComplited",
        src: a + "UI/Menus/Menu_LevelComplited.png"
    });
    data.push({
        name: "NewHighscore",
        src: a + "UI/Menus/NewHighscore.png"
    });
    data.push({
        name: "Menu_LevelMap",
    ...
    data.push({
        name: "Num_victory",
        src: a + "UI/Numbers/Num_victory.png"
    });
    data.push({
...
function loadImagesEnd(a) {
    console.log("===============loadImagesEnd()");
    bitmaps = a;
    a = [];
    a.push("Music/bomb");
    a.push("Music/button_switch_slide");
    a.push("Music/button_tick");
    a.push("Music/cannon");
    a.push("Music/ingame");
    a.push("Music/menu");
    a.push("Music/ouch");
    a.push("Music/sound133");
    a.push("Music/sound391");
    a.push("Music/sound412");
    a.push("Music/sound500");
...
function createScene() {
    ...
    mc.static = !0;
    stage.addChild(mc);
    gameState == STATE_MENU && (mc = 0 <= levelsScores[0] ? new Sprite(bitmaps.Button_Resume, 190, 76, 1) : new Sprite(bitmaps.Button_Play, 190, 76, 1), mc.x = 120, mc.y = 80, mc.static = !0, mc.onclick = function() {
        playBtnSound2();
        prepareLevel(curLevel)
    }, stage.addChild(mc), mc = new Sprite(bitmaps.Button_LevelMap, 165, 66), mc.x = 120, mc.y = 132, mc.static = !0, mc.onclick = function() {
        playBtnSound2();
        gameState = STATE_LEVELMAP;
        createScene()
    }, stage.addChild(mc), mc = new Sprite(bitmaps.Button_MoreGames, 165, 66), mc.x = 120, mc.y = 181, mc.static = !0, mc.onclick = showMoreGames
                                //, stage.addChild(mc)
                                );
    if (gameState == STATE_LEVELMAP) {
        for (var a = levels.length, c = 0; c < a; c++) 0 <= levelsScores[c] && (lastLevel = c);
        mc = new Sprite(bitmaps.Menu_LevelMap, 305, 305, 1);
        mc.x = 240;
        mc.y = 160;
        mc.static = !0;
        stage.addChild(mc);
        mc = new Sprite(bitmaps.Button_Ingame_Back, 63, 63, 1);
        mc.x = 60;
        mc.y = 160;
        mc.static = !0;
        mc.onclick = function() {
        ...
        stage.addChild(mc);
        mc = new Sprite(bitmaps.btn_more_games, 77, 77);
        mc.x = 445;
        mc.y = 270;
        ...
        for (c = 0; c < a; c++) {
            ...
            e.static = !0;
            e.write(c + 1);
            if (c <= lastLevel + 1) mc.levelId =
                c, mc.onclick = function(a) {
                    playBtnSound2();
    ...
    gameState == STATE_ALL_VICTORY && (mc = new Sprite(bitmaps.Menu_Victory, 333, 182, 1), mc.x = 240, mc.y = 160, mc.static = !0, stage.addChild(mc), a = getTotalLevelsScores(), c = new SimpleText(bitmaps.Num_victory_new, 17, 20), c.align = c.ALIGN_LEFT, c.x = 251, c.y = 136, c.static = !0, c.write(a), c = new SimpleText(bitmaps.Num_victory_new, 17, 20), c.align = c.ALIGN_LEFT, c.x = 323, c.y = 166, c.charMap.push("/"), c.static = !0, c.write(curLevel + 1 + "/" + levels.length), mc = new Sprite(bitmaps.Button_MoreGames, 165, 66, 1), mc.x = 240, mc.y = 210, mc.static = !0, mc.onclick = showMoreGames
                                       , stage.addChild(mc)
                                       , mc = new Sprite(bitmaps.Button_Ingame_Back, 63, 63, 1), mc.x = 60, mc.y = 160, mc.static = !0, mc.onclick = function() {
        playBtnSound();
        showMenu()
    }, stage.addChild(mc));
...
function startLevel(a, c) {
    ...
    if (levels[a]) {
        ...
        for (var k = 0; k < e.length; k++)
            if (g = e[k], h = findObject(g.type), mc = createObject(g, h), h.type == MOUNT_LEFT || h.type == MOUNT_RIGHT) mc.static = !1, stage.setZIndex(mc, 5), cannonMount = mc, h.type == MOUNT_LEFT ? (cannon = new Sprite(bitmaps.gun_left, 100, 55, 1), cannonDirect = 0) : (cannon = new Sprite(bitmaps.gun_right, 100, 55, 1), cannonDirect = 1), cannon.force = g.custom ? g.custom : 2E3, cannon.x = mc.x, cannon.y = mc.y - 10, stage.addChild(cannon), stage.setZIndex(cannon, mc.zIndex - 1);
        gameScore = 301;
        zombies = [];
        isSomeBombActive = !1;
        if (f)
            for (k = 0; k < f.length; k++) e = f[k], g = getBodyByPoint(e.point1), h = getBodyByPoint(e.point2 ? e.point2 : e.point1, g), 0 == e.type && box2DCreateRevoluteJoint(world, g, h, e.point1, e.custom), 1 == e.type && box2DCreateDistanceJoint(world, g, h, e.point1, e.point2), 2 == e.type && box2DCreatePrismaticJoint(world, g, h, e.point2, e.custom);
        gameState = STATE_GAME;
        mc = new Sprite(bitmaps.text_MC, 242, 30, 1);
        mc.x = 125;
        mc.y = 18;
        stage.addChild(mc);
        mc = new Sprite(bitmaps.Button_Ingame_Menu, 63, 63, 1);
        mc.x = 30;
        mc.y = 295;
        mc.onclick = function() {
            playBtnSound();
        ...
        mc.y = 295;
        isSoundOn ? mc.stop() : mc.gotoAndStop(1);
        mc.onclick = function(a) {
            if (gameState == STATE_GAME) return toggleSound(a), !1
        };
        //stage.addChild(mc);
        mc = new Sprite(bitmaps.Button_Ingame_Pause, 63, 63, 1);
        mc.x = 130;
        mc.y = 295;
        mc.onclick = function() {
            playBtnSound();
        ...
        stage.addChild(mc);
        mc = new Sprite(bitmaps.Button_Ingame_Restart, 63, 63, 1);
        mc.x =
            180;
        mc.y = 295;
        mc.onclick = function() {
        ...
        stage.addChild(mc);
        mc = new Sprite(bitmaps.Button_Ingame_Sponsor, 63, 63, 1);
        mc.x = 445;
        mc.y = 295;
        mc.sponsor = !0;
        mc.onclick = showMoreGames;
...
function fire(a) {
    if (gameState == STATE_GAME && !fireTimer) {
        ...
        cannon.rotation = 1 == cannonDirect ? angle : Math.PI + angle;
        for (a = 0; a < zombies.length; a++)(530 < zombies[a].body.x || -50 > zombies[a].body.x || 370 < zombies[a].body.y) &&
            destroyZombie(zombies[a], a, !1);
        0 < zombies.length && destroyZombie(zombies[0], 0, !0);
        a = {};
        ...
        a.joints.push(box2DCreateRevoluteJoint(world, a.body.box2dBody, a.hand1.box2dBody, new b2Vec2(c.x - 10.5,
            c.y - 9)));
        a.joints.push(box2DCreateRevoluteJoint(world, a.body.box2dBody, a.hand2.box2dBody, new b2Vec2(c.x + 6.5, c.y - 9)));
...
function createObject(a, c) {
    ...
    if (c.bodyType != NONE) {
        ...
        if (c.joints)
            for (f = 0; f < c.joints.length; f++) "pivot" == c.joints[f].type && (g = new Vector(c.joints[f].x, c.joints[f].y),
                0 != a.rotation && g.rotate(-a.rotation), g.x += a.x, g.y += a.y, g = box2DCreateCircle(world, g.x, g.y, 1, 0, !0, .01, 0, 0), box2DCreateRevoluteJoint(world, g, e, g.GetCenterPosition()));
        e.sprite = mc;
        e.type = c.type;
        mc.box2dBody = e
    }
...
function preTick() {
    ...
    if (gameState == STATE_GAME) {
        ...
        world.Step(1 / (2 * fps), 1);
        stage.box2dSync(world);
        for (var h = 0; h < stage.objects.length; h++) stage.objects[h].obType == ORANGE && a.push(stage.objects[h]), stage.objects[h].obType == DYNAMIC && c.push(stage.objects[h]), stage.objects[h].obType == BOMB && e.push(stage.objects[h]), stage.objects[h].sponsor && (g = stage.objects[h]);
        f = a.length;
        for (h = 0; h < a.length; h++) {
            var k = a[h];
            if (-20 > k.x || 600 < k.x || 340 < k.y) gameState = STATE_LOOSE, playSound("ouch"),
                stage.setTimeout(levelFailed, fps / 2), g.visible && (g.visible = !1, mc = new Sprite(bitmaps.Animation_Sponsor_Sad, 74, 74, 8), mc.x = g.x, mc.y = g.y + 2, mc.animDelay = 2, mc.onenterframe = function(a) {
                    6 == a.target.currentFrame && (a.target.destroy = !0, g.visible = !0)
                }, stage.addChild(mc));
            for (var l = k.box2dBody.GetContactList(); l; l = l.next)
                if (l.other.sprite && l.other.sprite.obType == ZOMBIE) {
                    f--;
                    k.destroy = !0;
                    world.DestroyBody(k.box2dBody);
                    l = Math.random();
                    g.visible && (g.visible = !1, mc = new Sprite(bitmaps.Animation_Sponsor_Happy, 74, 74, 8),
                        mc.x = g.x, mc.y = g.y + 2, mc.animDelay = 2, mc.onenterframe = function(a) {
                            7 == a.target.currentFrame && (a.target.destroy = !0, g.visible = !0)
                        }, stage.addChild(mc)); - 1 != k.name.indexOf("orange_1") ? .5 > l ? (mc = new Sprite(bitmaps.orangeJump_m_1, 36, 73, 11), l = "sound133") : (mc = new Sprite(bitmaps.orangeRotation_m_1, 44, 43, 11), l = "sound500") : -1 != k.name.indexOf("orange_3") ? .5 > l ? (mc = new Sprite(bitmaps.orangeJump_m_2, 30, 58, 15), l = "sound133") : (mc = new Sprite(bitmaps.orangeRotation_m_2, 32, 32, 15), l = "sound500") : .5 > l ? (mc = new Sprite(bitmaps.orangeBounce_m,
                        36, 32, 11), l = "sound391") : (mc = new Sprite(bitmaps.orangeTremble_m, 36, 32, 11), l = "sound412");
                    playSound(l);
                    mc.x = k.x;
                    mc.y = k.y;
                    mc.onenterframe = function(a) {
                        9 == a.target.currentFrame && (a.target.destroy = !0, 0 == f && (gameState = STATE_VICTORY, levelVictory()))
                    };
                    stage.addChild(mc);
                    break
                }
        ...
        for (h = 0; h < e.length; h++)
            if (a = e[h], (k = a.box2dBody.GetContactList()) && k.other.sprite && "chain" != k.other.sprite.name && !isSomeBombActive)
                if (k && k.other.type == ORANGE && (explode(a), isSomeBombActive = a.fuse = !0), a.box2dBody.GetLinearVelocity().Length() >=
                    a.break_force && !a.fuse) explode(a), isSomeBombActive = a.fuse = !0;
                else
                    for (k = a.box2dBody.GetContactList(); k; k = k.next)
                        if (k.other.GetLinearVelocity().Length() >= a.break_force && !a.fuse || k.other.sprite.obType == ZOMBIE) {
                            explode(a);
                            isSomeBombActive = a.fuse = !0;
                            break
                        }
        for (h = 0; h < c.length; h++)
            if (e = c[h], 600 < e.x || -100 > e.x || 500 < e.y) e.destroy = !0, world.DestroyBody(e.box2dBody)
    }
}
...
function explode(a) {
    ...
    a.onenterframe = function(e) {
        if (gameState == STATE_GAME && (c++, 100 == c)) {
            ...
            f = new b2AABB;
            var h = g.Copy();
            h.Subtract(new b2Vec2(65, 65));
            var k = g.Copy();
            k.Add(new b2Vec2(65, 65));
            f.minVertex = h;
            f.maxVertex = k;
            h = [];
            world.Query(f, h, 65);
...
function levelFailed() {
    gameState == STATE_LOOSE && (mc = new Sprite(bitmaps.Menu_Fail, 322, 139, 1), mc.x = 240, mc.y = 160, stage.addChild(mc), mc = new Sprite(bitmaps.Button_Restart, 165, 66, 1), mc.x = 240, mc.y = 190, mc.onclick = function() {
        playBtnSound2();
        prepareLevel(curLevel)
...
function levelVictory() {
    ...
    if (gameState == STATE_VICTORY) {
        levelsScores[curLevel] < gameScore && (levelsScores[curLevel] = gameScore, saveLevelsScores(), a = bitmaps.NewHighscore);
        popup = new SpritesGroup(stage);
        popup.x = 240;
        popup.y = 130;
        mc = new Sprite(bitmaps.Menu_InterlevelAuxiliary, 290, 87);
        mc.gx = 0;
        mc.gy = 0;
        popup.addChild(mc, !0);
        ...
        mc.gy = -1;
        popup.addChild(mc, !0);
        mc = new Sprite(bitmaps["Award_highscore" + (100 > levelsScores[curLevel] ? "_S" : "")], 22, 25, 1);
        mc.gx = 38;
        mc.gy = -1;
        popup.addChild(mc, !0);
        ...
        mc = new Sprite(bitmaps.Menu_LevelComplited,
            342, 158, 1);
        mc.x = 240;
        mc.y = 160;
        stage.addChild(mc);
        a && (mc = new Sprite(a, 126, 133, 1), mc.x = 340, mc.y = 180, mc.opacity = .5, mc.scaleX = .7, mc.scaleY = .7, stage.addChild(mc));
        mc = new Sprite(bitmaps.Button_Ingame_Restart, 63, 63, 1);
        mc.x = 65;
        mc.y = 160;
        mc.onclick = function() {
        ...
        stage.addChild(mc);
        mc = new Sprite(bitmaps.Button_Ingame_Next, 63, 63, 1);
        mc.x = 415;
        mc.y = 160;
        mc.onclick = function() {
        //window.location.href="objc://"+"gameOver:/0"; //by decamincow
        ...
        stage.addChild(mc);
        a = new SimpleText(bitmaps.Num_level_map_level_victory,
            14, 19);
        a.align = a.ALIGN_LEFT;
        a.x = 163;
        a.y = 147;
        a.write(gameScore);
        c = getTotalLevelsScores();
        ...
        ExternalAPI.openWidget(160, 50, "I scored " + getTotalLevelsScores() + " in Zombie Launcher 2 game! Try to beat me!")
    }
}
...
function toggleSound(a) {
    isSoundOn ? (isSoundOn = !1, a.target.gotoAndStop(1), mixer.stop(0)) : (isSoundOn = !0, a.target.gotoAndStop(0), gameState == STATE_GAME || gameState == STATE_VICTORY || gameState == STATE_LOOSE ? playSound("ingame", !0) : playSound("menu", !0));
    buildBackground();
    return !1
}

function playSound(a, c) {
    isSoundOn && (!c && AudioMixer.isWebAudioSupport() ? mixer.play(a, !1, !0, 1) : c && mixer.play(a, !0, !1, 0))
}
...
function drawScore() {
    if (gameState != STATE_MENU && gameState != STATE_LEVELMAP && gameState != STATE_ALL_VICTORY)
        if (gameState == STATE_GAME) {
            ...
            for (scoreText = new SimpleText(bitmaps.Num_in_game, 11, 11), scoreText.align = scoreText.ALIGN_LEFT, scoreText.x = 80, scoreText.y = 20, scoreText.write(gameScore), a = 0; a < scoreText.sprites.length; a++) scoreText.sprites[a].setZIndex(1)
}
var debug = {};

function playBtnSound() {
    playSound("button_tick")
}

function playBtnSound2() {
    playSound("button_switch_slide")
}
...
var objects = [{
        ...
        name: "orange_3",
        image: "Objects/Gameplay_Objects/orange_3.png",
        type: ORANGE,
        width: 30,
        height: 29,
        bodyWidth: 29,
        ...
        name: "earth_5",
        image: "Objects/Static_Objects/earth_5.png",
        width: 47,
        height: 44,
        bodyWidth: 40,
        bodyHeight: 40,
        ...
        name: "earth_6",
        image: "Objects/Static_Objects/earth_6.png",
        width: 43,
        height: 43,
        bodyWidth: 40,
        bodyHeight: 40,
        ...
        name: "grass_rounded",
        image: "Objects/Static_Objects/grass_rounded.png",
        width: 49,
        height: 15,
        bodyType: NONE
    }, {
        name: "grass_tile",
        image: "Objects/Static_Objects/grass_tile.png",
        width: 45,
        height: 15,
        bodyType: NONE
    }, {
        name: "box",
        image: "Objects/Dynamic_Objects/box.png",
        type: DYNAMIC,
        width: 57,
        height: 57,
        frames: 1,
        ...
        name: "chain_1",
        image: "Objects/Dynamic_Objects/chain_1.png",
        type: DYNAMIC,
        width: 12,
        height: 17,
        bodyWidth: 10,
        ...
        name: "chain_2",
        image: "Objects/Dynamic_Objects/chain_2.png",
        type: DYNAMIC,
        width: 6,
        height: 17,
        bodyWidth: 6,
        ...
        name: "chain_rusted_1",
        image: "Objects/Dynamic_Objects/chain_rusted_1.png",
        type: DYNAMIC,
        width: 12,
        height: 17,
        bodyWidth: 10,
        ...
        name: "chain_rusted_2",
        image: "Objects/Dynamic_Objects/chain_rusted_2.png",
        type: DYNAMIC,
        width: 6,
        height: 17,
        bodyWidth: 6,
        ...
        name: "wheel_big",
        image: "Objects/Dynamic_Objects/wheel_big.png",
        type: DYNAMIC,
        width: 45,
        height: 45,
        frames: 1,
        ...
        name: "wooden_ball",
        image: "Objects/Dynamic_Objects/wooden_ball.png",
        type: DYNAMIC,
        width: 44,
        height: 44,
        bodyWidth: 42,
        ...
        name: "rock_ball",
        image: "Objects/Dynamic_Objects/rock_ball.png",
        type: DYNAMIC,
        width: 44,
        height: 44,
        bodyWidth: 42,
        ...
        name: "rock_plate_1",
        image: "Objects/Dynamic_Objects/rock_plate_1.png",
        type: DYNAMIC,
        width: 259,
        height: 15,
        bodyWidth: 259,
        ...
        name: "rock_plate_2",
        image: "Objects/Dynamic_Objects/rock_plate_2.png",
        type: DYNAMIC,
        width: 186,
        height: 15,
        bodyWidth: 186,
        ...
        name: "rock_plate_3",
        image: "Objects/Dynamic_Objects/rock_plate_3.png",
        type: DYNAMIC,
        width: 168,
        height: 15,
        bodyWidth: 168,
        ...
        name: "rock_plate_4",
        image: "Objects/Dynamic_Objects/rock_plate_4.png",
        type: DYNAMIC,
        width: 113,
        height: 15,
        bodyWidth: 113,
